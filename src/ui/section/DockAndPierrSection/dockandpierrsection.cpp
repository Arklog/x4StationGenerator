...
#include "widgets/dockandpierrconfigurationpanel.hpp"
#include "widgets/dockandpierrselectionpanel.hpp"
...
DockAndPierrSection::DockAndPierrSection(QWidget *parent) : QWidget(parent), ui(new Ui::DockAndPierrSection) {
    ...
    auto dock_and_pierr_selection_panel = new DockAndPierrSelectionPanel(this);
    auto dock_and_pierr_configuration_panel = new DockAndPierrConfigurationPanel(this);
    ...
    connect(dock_and_pierr_selection_panel, &DockAndPierrSelectionPanel::moduleSelected, dock_and_pierr_configuration_panel, &DockAndPierrConfigurationPanel::addDockOrPierr);
}
