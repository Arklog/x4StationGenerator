...
ModuleConfiguration::ModuleConfiguration(const Module *dock_or_pierr, common::stationbuilder::ModuleTarget &target,
                                         QWidget *     parent) :
QWidget(parent),
ui(new Ui::ModuleConfiguration),
dock_or_pierr{dock_or_pierr},
module_target_(target) {
    ui->setupUi(this);
...
common::stationbuilder::ModuleTarget ModuleConfiguration::getModuleTarget() const {
