...
extern const xsdcpp::ElementInfo _languageType_Info;
extern const xsdcpp::ElementInfo _languageType_page_t_Info;
extern const xsdcpp::ElementInfo _languageType_page_t_t_t_Info;
...
void _set_languageType_page_t_t_t(t::languageType_page_t_t_t* obj, const xsdcpp::Position& pos, std::string&& val) { xsd::string& base = *obj; xsdcpp::set_string(&base, pos, std::move(val)); }
...
void* _get_languageType_page(t::languageType* parent) {return (parent->page.emplace_back(), &parent->page.back());}
xsdcpp::ChildElementInfo _languageType_Children[] = {
    {"page", 0, (xsdcpp::get_field_t)&_get_languageType_page, &t::_languageType_page_t_Info, 0, 0},
    {nullptr}
};
void* _get_languageType_id(t::languageType* elem) { return &elem->id; }
void _any_languageType(t::languageType* element, std::string&& name, std::string&& value) { element->other_attributes.emplace_back(xsd::any_attribute{std::move(name), std::move(value)}); }
xsdcpp::AttributeInfo _languageType_Attributes[] = {
    {"id", 1ULL, (xsdcpp::get_field_t)&_get_languageType_id, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, true, nullptr},
    {nullptr}
};
struct _root_t
{
...
void* _get__root_t_language(_root_t* parent) {return &parent->language;}
xsdcpp::ChildElementInfo __root_t_Children[] = {
    {"language", 0, (xsdcpp::get_field_t)&_get__root_t_language, &t::_languageType_Info, 1, 1},
    {nullptr}
};
void* _get_languageType_page_t_t(t::languageType_page_t* parent) {return (parent->t.emplace_back(), &parent->t.back());}
xsdcpp::ChildElementInfo _languageType_page_t_Children[] = {
    {"t", 0, (xsdcpp::get_field_t)&_get_languageType_page_t_t, &t::_languageType_page_t_t_t_Info, 0, 0},
    {nullptr}
};
void* _get_languageType_page_t_id(t::languageType_page_t* elem) { return &elem->id; }
void* _get_languageType_page_t_title(t::languageType_page_t* elem) { return &*(elem->title = xsd::string()); }
void* _get_languageType_page_t_descr(t::languageType_page_t* elem) { return &*(elem->descr = xsd::string()); }
void* _get_languageType_page_t_voice(t::languageType_page_t* elem) { return &*(elem->voice = xsd::string()); }
void _any_languageType_page_t(t::languageType_page_t* element, std::string&& name, std::string&& value) { element->other_attributes.emplace_back(xsd::any_attribute{std::move(name), std::move(value)}); }
xsdcpp::AttributeInfo _languageType_page_t_Attributes[] = {
    {"id", 1ULL, (xsdcpp::get_field_t)&_get_languageType_page_t_id, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, true, nullptr},
    {"title", 2ULL, (xsdcpp::get_field_t)&_get_languageType_page_t_title, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"descr", 4ULL, (xsdcpp::get_field_t)&_get_languageType_page_t_descr, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"voice", 8ULL, (xsdcpp::get_field_t)&_get_languageType_page_t_voice, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {nullptr}
};
void* _get_languageType_page_t_t_t_id(t::languageType_page_t_t_t* elem) { return &elem->id; }
xsdcpp::AttributeInfo _languageType_page_t_t_t_Attributes[] = {
    {"id", 1ULL, (xsdcpp::get_field_t)&_get_languageType_page_t_t_t_id, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, true, nullptr},
    {nullptr}
};
...
const xsdcpp::ElementInfo _languageType_Info = { xsdcpp::ElementInfo::EntryPointFlag|xsdcpp::ElementInfo::AnyAttributeFlag, nullptr, _languageType_Children, 1, _languageType_Attributes, 1ULL, nullptr, (xsdcpp::set_any_attribute_t)&_any_languageType };
...
const xsdcpp::ElementInfo _languageType_page_t_Info = { xsdcpp::ElementInfo::AnyAttributeFlag, nullptr, _languageType_page_t_Children, 1, _languageType_page_t_Attributes, 1ULL, nullptr, (xsdcpp::set_any_attribute_t)&_any_languageType_page_t };
const xsdcpp::ElementInfo _languageType_page_t_t_t_Info = { xsdcpp::ElementInfo::ReadTextFlag, (xsdcpp::set_value_t)&t::_set_languageType_page_t_t_t, nullptr, 0, _languageType_page_t_t_t_Attributes, 1ULL, nullptr, nullptr };

void load_data(const std::string& data, languageType& output)
{
    _root_t rootElement;
    xsdcpp::ElementContext elementContext(&__root_t_Info, &rootElement);
    xsdcpp::parse(data.c_str(), _namespaces, elementContext);
    output = std::move(rootElement.language);
}

void load_file(const std::string& filePath, languageType& output)
{
