...
extern const xsdcpp::ElementInfo _groupsType_Info;
extern const xsdcpp::ElementInfo _groupsType_group_t_Info;
...
void* _get_groupsType_group(waregroups::groupsType* parent) {return (parent->group.emplace_back(), &parent->group.back());}
xsdcpp::ChildElementInfo _groupsType_Children[] = {
    {"group", 0, (xsdcpp::get_field_t)&_get_groupsType_group, &waregroups::_groupsType_group_t_Info, 1, 0},
    {nullptr}
};
struct _root_t
{
    waregroups::groupsType groups;
};

void* _get__root_t_groups(_root_t* parent) {return &parent->groups;}
xsdcpp::ChildElementInfo __root_t_Children[] = {
    {"groups", 0, (xsdcpp::get_field_t)&_get__root_t_groups, &waregroups::_groupsType_Info, 1, 1},
    {nullptr}
};
void* _get_groupsType_group_t_factoryhudicon(waregroups::groupsType_group_t* elem) { return &*(elem->factoryhudicon = xsd::string()); }
void* _get_groupsType_group_t_factorymapicon(waregroups::groupsType_group_t* elem) { return &*(elem->factorymapicon = xsd::string()); }
void* _get_groupsType_group_t_factoryname(waregroups::groupsType_group_t* elem) { return &*(elem->factoryname = xsd::string()); }
void* _get_groupsType_group_t_icon(waregroups::groupsType_group_t* elem) { return &*(elem->icon = xsd::string()); }
void* _get_groupsType_group_t_id(waregroups::groupsType_group_t* elem) { return &elem->id; }
void* _get_groupsType_group_t_name(waregroups::groupsType_group_t* elem) { return &elem->name; }
void* _get_groupsType_group_t_priority(waregroups::groupsType_group_t* elem) { return &*(elem->priority = int64_t()); }
void* _get_groupsType_group_t_tags(waregroups::groupsType_group_t* elem) { return &elem->tags; }
void* _get_groupsType_group_t_tier(waregroups::groupsType_group_t* elem) { return &*(elem->tier = int64_t()); }
xsdcpp::AttributeInfo _groupsType_group_t_Attributes[] = {
    {"factoryhudicon", 1ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_factoryhudicon, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"factorymapicon", 2ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_factorymapicon, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"factoryname", 4ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_factoryname, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"icon", 8ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_icon, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"id", 16ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_id, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {"name", 32ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_name, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {"priority", 64ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_priority, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, false, nullptr},
    {"tags", 128ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_tags, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {"tier", 256ULL, (xsdcpp::get_field_t)&_get_groupsType_group_t_tier, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, false, nullptr},
    {nullptr}
};
...
const xsdcpp::ElementInfo _groupsType_Info = { xsdcpp::ElementInfo::EntryPointFlag|xsdcpp::ElementInfo::CheckChildrenFlag, nullptr, _groupsType_Children, 1, nullptr, 0ULL, nullptr, nullptr };
...
const xsdcpp::ElementInfo _groupsType_group_t_Info = { 0, nullptr, nullptr, 0, _groupsType_group_t_Attributes, 176ULL, nullptr, nullptr };

void load_data(const std::string& data, groupsType& output)
{
    _root_t rootElement;
    xsdcpp::ElementContext elementContext(&__root_t_Info, &rootElement);
    xsdcpp::parse(data.c_str(), _namespaces, elementContext);
    output = std::move(rootElement.groups);
}

void load_file(const std::string& filePath, groupsType& output)
{
