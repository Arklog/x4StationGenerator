...
extern const xsdcpp::ElementInfo _modulesType_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_category_t_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_category_t_extension_t_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_limits_t_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_maxlimits_t_Info;
extern const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_production_t_Info;
...
void* _get_modulesType_module(modules::modulesType* parent) {return (parent->module.emplace_back(), &parent->module.back());}
xsdcpp::ChildElementInfo _modulesType_Children[] = {
    {"module", 0, (xsdcpp::get_field_t)&_get_modulesType_module, &modules::_modulesType_module_t_Info, 1, 0},
    {nullptr}
};
void* _get_modulesType_noNamespaceSchemaLocation(modules::modulesType* elem) { return &elem->noNamespaceSchemaLocation; }
xsdcpp::AttributeInfo _modulesType_Attributes[] = {
    {"noNamespaceSchemaLocation", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_noNamespaceSchemaLocation, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {nullptr}
};
struct _root_t
{
...
void* _get__root_t_modules(_root_t* parent) {return &parent->modules;}
xsdcpp::ChildElementInfo __root_t_Children[] = {
    {"modules", 0, (xsdcpp::get_field_t)&_get__root_t_modules, &modules::_modulesType_Info, 1, 1},
    {nullptr}
};
void* _get_modulesType_module_t_category_t_extension(modules::modulesType_module_t_category_t* parent) {return (parent->extension.emplace_back(), &parent->extension.back());}
xsdcpp::ChildElementInfo _modulesType_module_t_category_t_Children[] = {
    {"extension", 0, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_extension, &modules::_modulesType_module_t_category_t_extension_t_Info, 0, 0},
    {nullptr}
};
void* _get_modulesType_module_t_category_t_comment(modules::modulesType_module_t_category_t* elem) { return &*(elem->comment = xsd::string()); }
void* _get_modulesType_module_t_category_t_faction(modules::modulesType_module_t_category_t* elem) { return &*(elem->faction = xsd::string()); }
void* _get_modulesType_module_t_category_t_race(modules::modulesType_module_t_category_t* elem) { return &*(elem->race = xsd::string()); }
void* _get_modulesType_module_t_category_t_tags(modules::modulesType_module_t_category_t* elem) { return &elem->tags; }
void* _get_modulesType_module_t_category_t_ware(modules::modulesType_module_t_category_t* elem) { return &*(elem->ware = xsd::string()); }
xsdcpp::AttributeInfo _modulesType_module_t_category_t_Attributes[] = {
    {"comment", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_comment, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"faction", 2ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_faction, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"race", 4ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_race, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"tags", 8ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_tags, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {"ware", 16ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_ware, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {nullptr}
};
void* _get_modulesType_module_t_category(modules::modulesType_module_t* parent) {return &parent->category;}
void* _get_modulesType_module_t_compatibilities(modules::modulesType_module_t* parent) {return &*(parent->compatibilities = modules::modulesType_module_t_compatibilities_t());}
xsdcpp::ChildElementInfo _modulesType_module_t_Children[] = {
    {"category", 0, (xsdcpp::get_field_t)&_get_modulesType_module_t_category, &modules::_modulesType_module_t_category_t_Info, 1, 1},
    {"compatibilities", 1, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities, &modules::_modulesType_module_t_compatibilities_t_Info, 0, 1},
    {nullptr}
};
void* _get_modulesType_module_t_base(modules::modulesType_module_t* elem) { return &*(elem->base = xsd::string()); }
void* _get_modulesType_module_t_group(modules::modulesType_module_t* elem) { return &elem->group; }
void* _get_modulesType_module_t_id(modules::modulesType_module_t* elem) { return &elem->id; }
xsdcpp::AttributeInfo _modulesType_module_t_Attributes[] = {
    {"base", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_base, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"group", 2ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_group, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {"id", 4ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_id, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {nullptr}
};
void* _get_modulesType_module_t_category_t_extension_t_faction(modules::modulesType_module_t_category_t_extension_t* elem) { return &elem->faction; }
void* _get_modulesType_module_t_category_t_extension_t_race(modules::modulesType_module_t_category_t_extension_t* elem) { return &*(elem->race = xsd::string()); }
xsdcpp::AttributeInfo _modulesType_module_t_category_t_extension_t_Attributes[] = {
    {"faction", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_extension_t_faction, (xsdcpp::set_value_t)&xsdcpp::set_string, true, nullptr},
    {"race", 2ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_category_t_extension_t_race, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {nullptr}
};
void* _get_modulesType_module_t_compatibilities_t_limits(modules::modulesType_module_t_compatibilities_t* parent) {return &*(parent->limits = modules::modulesType_module_t_compatibilities_t_limits_t());}
void* _get_modulesType_module_t_compatibilities_t_maxlimits(modules::modulesType_module_t_compatibilities_t* parent) {return &*(parent->maxlimits = modules::modulesType_module_t_compatibilities_t_maxlimits_t());}
void* _get_modulesType_module_t_compatibilities_t_production(modules::modulesType_module_t_compatibilities_t* parent) {return (parent->production.emplace_back(), &parent->production.back());}
xsdcpp::ChildElementInfo _modulesType_module_t_compatibilities_t_Children[] = {
    {"limits", 0, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_limits, &modules::_modulesType_module_t_compatibilities_t_limits_t_Info, 0, 1},
    {"maxlimits", 1, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_maxlimits, &modules::_modulesType_module_t_compatibilities_t_maxlimits_t_Info, 0, 1},
    {"production", 2, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_production, &modules::_modulesType_module_t_compatibilities_t_production_t_Info, 1, 0},
    {nullptr}
};
void* _get_modulesType_module_t_compatibilities_t_limits_t_production(modules::modulesType_module_t_compatibilities_t_limits_t* elem) { return &elem->production; }
xsdcpp::AttributeInfo _modulesType_module_t_compatibilities_t_limits_t_Attributes[] = {
    {"production", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_limits_t_production, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, true, nullptr},
    {nullptr}
};
void* _get_modulesType_module_t_compatibilities_t_maxlimits_t_production(modules::modulesType_module_t_compatibilities_t_maxlimits_t* elem) { return &elem->production; }
xsdcpp::AttributeInfo _modulesType_module_t_compatibilities_t_maxlimits_t_Attributes[] = {
    {"production", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_maxlimits_t_production, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, true, nullptr},
    {nullptr}
};
void* _get_modulesType_module_t_compatibilities_t_production_t_chance(modules::modulesType_module_t_compatibilities_t_production_t* elem) { return &elem->chance; }
void* _get_modulesType_module_t_compatibilities_t_production_t_ref(modules::modulesType_module_t_compatibilities_t_production_t* elem) { return &*(elem->ref = xsd::string()); }
void* _get_modulesType_module_t_compatibilities_t_production_t_ware(modules::modulesType_module_t_compatibilities_t_production_t* elem) { return &*(elem->ware = xsd::string()); }
xsdcpp::AttributeInfo _modulesType_module_t_compatibilities_t_production_t_Attributes[] = {
    {"chance", 1ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_production_t_chance, (xsdcpp::set_value_t)&xsdcpp::set_int64_t, true, nullptr},
    {"ref", 2ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_production_t_ref, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {"ware", 4ULL, (xsdcpp::get_field_t)&_get_modulesType_module_t_compatibilities_t_production_t_ware, (xsdcpp::set_value_t)&xsdcpp::set_string, false, nullptr},
    {nullptr}
};
...
const xsdcpp::ElementInfo _modulesType_Info = { xsdcpp::ElementInfo::EntryPointFlag|xsdcpp::ElementInfo::CheckChildrenFlag, nullptr, _modulesType_Children, 1, _modulesType_Attributes, 1ULL, nullptr, nullptr };
...
const xsdcpp::ElementInfo _modulesType_module_t_category_t_Info = { 0, nullptr, _modulesType_module_t_category_t_Children, 1, _modulesType_module_t_category_t_Attributes, 8ULL, nullptr, nullptr };
const xsdcpp::ElementInfo _modulesType_module_t_Info = { xsdcpp::ElementInfo::CheckChildrenFlag, nullptr, _modulesType_module_t_Children, 2, _modulesType_module_t_Attributes, 6ULL, nullptr, nullptr };
const xsdcpp::ElementInfo _modulesType_module_t_category_t_extension_t_Info = { 0, nullptr, nullptr, 0, _modulesType_module_t_category_t_extension_t_Attributes, 1ULL, nullptr, nullptr };
const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_Info = { xsdcpp::ElementInfo::CheckChildrenFlag, nullptr, _modulesType_module_t_compatibilities_t_Children, 3, nullptr, 0ULL, nullptr, nullptr };
const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_limits_t_Info = { 0, nullptr, nullptr, 0, _modulesType_module_t_compatibilities_t_limits_t_Attributes, 1ULL, nullptr, nullptr };
const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_maxlimits_t_Info = { 0, nullptr, nullptr, 0, _modulesType_module_t_compatibilities_t_maxlimits_t_Attributes, 1ULL, nullptr, nullptr };
const xsdcpp::ElementInfo _modulesType_module_t_compatibilities_t_production_t_Info = { 0, nullptr, nullptr, 0, _modulesType_module_t_compatibilities_t_production_t_Attributes, 1ULL, nullptr, nullptr };

void load_data(const std::string& data, modulesType& output)
{
    _root_t rootElement;
    xsdcpp::ElementContext elementContext(&__root_t_Info, &rootElement);
    xsdcpp::parse(data.c_str(), _namespaces, elementContext);
    output = std::move(rootElement.modules);
}

void load_file(const std::string& filePath, modulesType& output)
{
